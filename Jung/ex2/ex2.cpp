...
/**
*	@file
*	reads in measured-1.0.0.2017-02-03.b0050c5c8deb1db59c7b2644414b079d.xml and creates an csv file getting from the input line
*	using RapidXml as xml-Parser (http://rapidxml.sourceforge.net)
* 	@param  argc An integer argument count of the command line arguments
*	@param  argv The filename to create
*/
