...
public class ex5 {
    ...
    public static void main(String[] args){
        ...
        if(args[0].equals(MYALGORITHM))
        {
            ...
            furthestNodeId = dijkstra.getHighestDistanceNode();
            furthestNodeDistance = dijkstra.distances[furthestNodeId];
        /** Mode 1: Use library Dijkstra implementation */
        	...
        	furthestNodeId = dijkstra.findFurthestNode(nodes[0]);
            furthestNodeDistance = dijkstra.distances[furthestNodeId];
        }else{
        ...
        String resultVertex = "RESULT VERTEX " + (Integer.valueOf(furthestNodeId)+1);
        String resultDist = "RESULT DIST " + furthestNodeDistance;
