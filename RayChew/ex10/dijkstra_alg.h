...
namespace dijkstra_alg {
  ...
  std::pair<std::vector<int>,std::vector<int>> alg (int& n, myHeap& Unvisited, std::vector<std::vector<vertex>>& adjList, int& startTerminal, std::vector<Edge>& subgraphEdges);
